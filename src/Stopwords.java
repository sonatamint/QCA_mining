...
public class Stopwords {
  ...
  static{  
    //Stopwords list from Rainbow: http://www.cs.cmu.edu/~mccallum/bow/rainbow/
	  add("ansy");//
	  add("analysis");//
	  add("problem");//
	  add("model");//
  ...
  static void add(String thisword){
	  m_Words.add(thisword);
  }
  ...
  public static String showAll() {
    ...
    Iterator<String> iterator=m_Words.iterator();
